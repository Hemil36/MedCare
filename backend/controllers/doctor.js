...
export const recordAppointment = async (req, res) => {
    ...
    try {
        ...
        await sendEmail({ patientName, patientEmail: email, diagnosis, doctorName: appointment.doctorID, remarks: notes, medicationPrescription: prescription, prescriptionDate: new Date(), doctorName })
